...
public class EmployeeArrayList {
   ...
   // When we want to print in one line

            System.out.println("Employee name : "+ EmployeeeList.get(i).getName() + " Employee salary : " + EmployeeeList.get(i).getSalary() +"Employee company : "+ EmployeeeList.get(i).getCompany());
